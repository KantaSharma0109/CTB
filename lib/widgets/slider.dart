...
class AppSliderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (context.watch<MainContainerViewModel>().appslider.isEmpty) {
      context.read<MainContainerViewModel>().fetchData();
    }

    final appslider = context.watch<MainContainerViewModel>().appslider;

    if (appslider.isEmpty) {
      return const Center(
    ...
    return CarouselSlider.builder(
      ...
      options: CarouselOptions(
        ...
        //         ? false
        //         : true,
        enableInfiniteScroll: appslider.length > 1,
      ),
      itemBuilder: (context, index, realIdx) {
        // final slider = context.watch<MainContainerViewModel>().appslider[index];
        // String imageUrl = slider.image_path;
        final slider = appslider[index];
        String imageUrl = slider.image_path;
        return Padding(
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    //   // imageUrl: imageUrl,
                    //   imageUrl:
                    //       'https://dashboard.cheftarunabirla.com/images/uploads/1655201426132.webp',
