                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                          ...
                          //     right: 5.0), // Spacing between cards
                          padding: EdgeInsets.only(
                            left: index == 0
                                ? 16.0
                                : 3.0, // Extra space for the first card
                            right: index ==
                                    Provider.of<MainContainerViewModel>(context,
                                                listen: false)
                                            .featured_courses
                                            .length -
                                        1
                                ? 16.0 // Extra space for the last card
                                : 3.0, // Standard space between cards
                          ),
                          child: SizedBox(
                              width: constraints.maxWidth < 576
                                  ? 200.0
                                  : 200.0, // Adjust card width
                              child:
                                  // CourseMainCard(
                                  CourseMainCard(
                                marginLeft: index == 0
                                    ? 10.0
                                    : 5.0, // Margin for the first card
                                marginRight: index ==
                                ...
                                course: Provider.of<MainContainerViewModel>(
                                        context,
                                        listen: false)
                                    .featured_courses[index],
                                onWhislistPressed: () {
