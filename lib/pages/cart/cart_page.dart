...
class _CartPageState extends State<CartPage> {
  ...
  //   Map<String, dynamic> _updateCart = await MySqlDBService().runQuery(
  //     requestType: RequestType.POST,
  //     url: '${Constants.baseUrl}userCartWishlist.php?action=$action',
  //     body: {
  //       'user_id': Application.userId,
  //       'category': category,
  //       'id': id,
  ...
  Future<void> getUserCart({String couponId = ''}) async {
    ...
    // String url = couponId.isEmpty
    //     ? '${Constants.baseUrl}getUserCart.php?user_id=${Application.userId}'
    //     : '${Constants.baseUrl}getUserCart.php?user_id=${Application.userId}&couponId=$couponId';
  ...
  //     // Safe parsing of double values
  //     sumTotal = _parseDouble(_data[ApiKeys.sumTotal]);
  //     paybleAmount = _parseDouble(_data[ApiKeys.paybleAmount]);
  //     shippingCharges = _parseDouble(_data[ApiKeys.shippingCharges]);
  //     wallet = _parseDouble(_data[ApiKeys.wallet]);
  ...
  //     print('Shipping Charges: $shippingCharges');
  //     print('wallet: $wallet');
  //     print('appliedCouponId: $appliedCouponId');
  //     // Adding cart items
  //     _data[ApiKeys.courseCart]?.forEach((cart) {
  //       cartList.add(CartItem.fromJson(cart));
  //     });
