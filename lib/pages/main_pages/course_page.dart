...
class _CoursePageState extends State<CoursePage> {
  ...
  Future<void> updateWhislist(id, value, imagePath,
    ...
    String url = value == 'add'
        // ? '${Constants.baseUrl}cartWishlist.php?action=addToWhislist'
        // : '${Constants.baseUrl}cartWishlist.php?action=removeFromWhislist';
        ? '${Constants.finalUrl}/courses_api/addToWhislist'
        : '${Constants.finalUrl}/courses_api/removeFromWhislist';
    //   // Determine action
    // String action = value == 'add' ? 'addToWishlist' : 'removeFromWishlist';
    // String url = '${Constants.baseUrl}cartWishlist.php?action=$action';
  ...
  // Future<void> updateWhislist(String id, String value, String imagePath,
  //     {String title = '', String price = ''}) async {
  //   // Define parameters
  //   Map<String, String> params = {
  //     'user_id': Application.userId,
  ...
  //   // Send POST request
  //   Map<String, dynamic> _postResult = await ApiFunctions.postApiResult(
  //     url,
  ...
  //     if (_data['message'] == 'success') {
  //       if (value == 'add') {
  //         Utility.showSnacbar(context, 'Item successfully added to wishlist!!');
  //       } else {
  //         Utility.showSnacbar(
  //             context, 'Item successfully removed from wishlist!!');
  //       }
  //     } else if (_data['message'] == 'Auth_token_failure') {
  //       Utility.authErrorPopup(
  //         context,
  //         'Authentication error. Contact support: ${Application.adminPhoneNumber}',
  //       );
  //     } else {
  //       Utility.showSnacbar(context, 'Some error occurred!!');
  //     }
  ...
  // Future<bool> updateCart(String id, String value, String imagePath,
  //     {String title = '', String price = ''}) async {
  //   Utility.showProgress(true);
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: 110.0, // Increased height for better visibility
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        width:
                            80.0, // Fixed width to ensure uniform size for each box
                        margin: index == 0
                          ...
                          children: [
                            ...
                            ClipOval(
                              child: CachedNetworkImage(
                                imageUrl: Provider.of<MainContainerViewModel>(
                                        context,
                                        listen: false)
                                    .courseCategories[index]
                                    .image_path,
                                ...
                                errorWidget: (context, url, error) =>
                                    const ImagePlaceholder(),
                                fit: BoxFit.cover,
                                width: 70.0, // Circular image width
                                height: 70.0, // Circular image height
                              ),
                            ),
                            const SizedBox(
                                height: 8.0), // Spacing between image and name
                            // Product Name Text
                            Text(
                              Provider.of<MainContainerViewModel>(context,
                                      listen: false)
                                  ...
                                  .name,
                              style: TextStyle(
                                  color: Provider.of<CoursePageViewModel>(
                                                  context,
                                                  listen: false)
                                              .selectedCategory ==
                              ...
                              overflow: TextOverflow
                                  .ellipsis, // Show dots for long text
                            ),
                          ],
                        ),
                      ),
