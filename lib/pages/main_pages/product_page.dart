...
class _ProductPageState extends State<ProductPage>
  ...
  // Future<void> updateWhislist(id, value) async {
  //   // Prepare parameters to pass in the body as a JSON format
  //   Map<String, String> params = {
  //     'user_id': Application
  //         .userId, // Ensure Application.userId holds the user ID value
  //     'category':
  //         'product', // For this example, I'm assuming the category is 'product'
  //     'id': id
  //         .toString(), // Convert ID to string as PHP expects the value to be a string
  //   };
  ...
  //         if (value == 'add') {
  //           Utility.showSnacbar(
  //               context, 'Item successfully added to wishlist!!');
  //         } else {
  //           Utility.showSnacbar(
  ...
  //         Utility.authErrorPopup(
  //             context,
  //             'Sorry for the inconvenience. There is an authentication problem with your account. Contact support: ' +
  //                 Application.adminPhoneNumber);
  //       } else {
  //         Utility.showSnacbar(context, 'Some error occurred!!');
  //       }
  ...
  //     Utility.showSnacbar(context, 'Something went wrong, please try again.');
  //   }
  // }
                          ...
                          children: [
                            ...
                            Text(
                              Provider.of<MainContainerViewModel>(context,
                                  ...
                                  .name,
                              style: TextStyle(
                                  color: Provider.of<ProductPageViewModel>(
                                                  context,
                                                  listen: false)
                                              .selectedCategory ==
                                          Provider.of<MainContainerViewModel>(
