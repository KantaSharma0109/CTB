...
// Make the API call
  ...
  //   Map<String, String> params = {
  //     'user_id': Application.userId,
  //     'category': 'product', // Or other category like 'course', 'book', etc.
  //     'id': id.toString(),
  //     'description': descriptionController.text.isEmpty
  //         ? 'nothing'
  //         : descriptionController.text,
  ...
  //         Utility.authErrorPopup(
  //             context,
  //             'Sorry for inconvenience. There is some authentication issue regarding your account. Contact support: ' +
  //                 Application.adminPhoneNumber);
  //       } else {
  //         Utility.showSnacbar(context, 'Some error occurred!!');
  //       }
