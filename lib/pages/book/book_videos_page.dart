...
class _BookVideosPageState extends State<BookVideosPage> {
  ...
  // Future<void> updateCart(id, value) async {
  //   final String action = value == 'add' ? 'addtocart' : 'removefromcart';

  //   final response = await http.post(
  //     Uri.parse('${Constants.baseUrl}userCartWishlist.php?action=$action'),
  //     headers: {'Content-Type': 'application/json'},
  //     body: json.encode({
  //       'user_id': user_id,
  //       'category': 'book-videos', // Adjust category if needed
  //       'id': widget.book_id,
  //     }),
  //   );
  ...
  Future<void> updateBookSubscription() async {
    Map<String, dynamic> _getNews = await MySqlDBService().runQuery(
      ...
      // '${Constants.baseUrl}userSubscription.php?action=updateBookVideosSubscription&book_id=${widget.book_id}&user_id=$user_id',
    );
